...
Note that this is a deprecated version kept here for legacy purposes. The cucrrent version of uniQC can be found [here](https://github.com/translationalneuromodeling/tapas) as part of the TAPAS toolbox[1].
...
Example data can be made available upon request (saskia.bollmann@cai.uq.edu.au). Please put the data directory at the same level as the code, demo and test directory.
